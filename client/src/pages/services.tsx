...
const services = [
  {
    ...
    icon: Compass,
    heroImage:
      "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
    shortDescription:
      "Award-winning exhibition stands that captivate and convert",
    fullDescription:
      "Step into the exhibition floor with confidence, knowing your stand will shine with our award-winning design and build expertise. We create a perfect blend of artistry, functionality, and professionalism that elevates your brand presence from conceptualization to execution.",
    features: [
  ...
  },
  {
    ...
    icon: Calendar,
    heroImage:
      "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
    shortDescription:
      "Complete event solutions that create memorable experiences",
    fullDescription:
      "Experience unforgettable moments with our expert event setup and management. Our team crafts intelligent and captivating environments that spark meaningful connections and forge lifelong bonds between your brand and audience.",
    features: [
  ...
  },
  {
    ...
    icon: Hammer,
    heroImage:
      "https://images.unsplash.com/photo-1504307651254-35680f356dfd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
    shortDescription: "Expert craftsmanship for stunning custom structures",
    fullDescription:
      "Expert craftsmanship meets innovative design. Our skilled carpenters and builders create stunning custom structures that bring your vision to life with precision, quality, and attention to detail that exceeds industry standards.",
    features: [
  ...
  },
  {
    ...
    fullDescription:
      "Transform your space into an unforgettable experience. Our expert interior designers craft unique environments that touch hearts and minds, perfectly tailored to your vision and brand identity while creating lasting impressions on visitors.",
    features: [
  ...
  },
  {
    ...
    icon: Store,
    heroImage:
      "https://images.unsplash.com/photo-1472851294608-062f824d29cc?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
    shortDescription: "Captivating displays where art meets technology",
    fullDescription:
      "Create captivating displays where art meets technology. Our bespoke visual merchandising solutions blend style and innovation to create unforgettable retail experiences that drive engagement and sales.",
    features: [
  ...
  },
  {
    ...
    icon: Landmark,
    heroImage:
      "https://images.unsplash.com/photo-1594736797933-d0501ba2fe65?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
    shortDescription: "Immersive experiences with cutting-edge technology",
    fullDescription:
      "Transform museum exhibitions and expo displays with cutting-edge technology and sustainable design. We create immersive experiences that spark connection, discovery, and learning through innovative presentation techniques.",
    features: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto mb-8">
              From exhibition design to complete event management, we deliver
              exceptional experiences that elevate your brand and captivate your
              audience.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Badge
                variant="outline"
                className="px-4 py-2 text-lg border-white text-white"
              >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* Features */}
                    <div className="mb-8">
                      <h3 className="text-lg font-semibold text-[hsl(var(--charcoal))] mb-4">
                        What's Included:
                      </h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      >
                        <a
                          href={`https://wa.me/971545321419?text=Hello%2C%20I%27m%20interested%20in%20learning%20more%20about%20your%20${encodeURIComponent(service.title)}%20service.%20Could%20you%20provide%20more%20details%3F`}
                          target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              process that ensures exceptional results and client satisfaction.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Consultation",
                description:
                  "We begin with understanding your vision, requirements, and objectives",
                icon: Users,
              },
              {
                step: "02",
                ...
                description:
                  "Our team creates detailed designs and comprehensive project plans",
                icon: Compass,
              },
              {
                step: "03",
                title: "Production",
                description:
                  "Expert craftsmen bring your vision to life with precision and quality",
                icon: Hammer,
              },
              {
                step: "04",
                title: "Installation",
                description:
                  "Professional setup and installation at your chosen venue",
                icon: Target,
              },
              {
                step: "05",
              ...
              },
              {
                ...
                title: "Follow-up",
                description:
                  "Post-event analysis and future planning discussions",
                icon: Award,
              },
            ].map((process, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="relative overflow-hidden shadow-lg border-0 hover:shadow-xl transition-shadow"
                >
